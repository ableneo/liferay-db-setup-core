...
public class SetupMenus {
    ...
    private static void createMenuItems(
        ...
        long userId,
        ServiceContext serviceContext,
        SiteNavigationMenu parentMenu,
        SiteNavigationMenuItem parentMenuItem,
        MenuItem addFromMenuItems
    ) {
    ...
    private static SiteNavigationMenuItem createMenuItem(
        long groupId,
        long userId,
        ServiceContext serviceContext,
        long parentMenuId,
        ...
        LOG.info(
            " i setting item '" + newMenuItem.getName() + "' as '" + type + "': [" + newMenuItem.getTypeSettings() + "]"
        );
        ...
        try {
            List<SiteNavigationMenuItem> items = SiteNavigationMenuItemLocalServiceUtil.getSiteNavigationMenuItems(
                parentMenuId,
                parentMenuItem
            );
    ...
    private static SiteNavigationMenuItem getExistingFromList(
        MenuItem newMenuItem,
        List<SiteNavigationMenuItem> currentItems
    ) {
